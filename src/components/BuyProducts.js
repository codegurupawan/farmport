    ...
    return (
        <>
            <div className="my-5 bg-gradient">
                ...
                <h1 className="text-center mt-10 mrgn">Fill Your Details Here</h1>
                            ...
                            <form onSubmit={formSubmit}>
                                ...
                                <div className="mb-3">
                                    <label htmlFor="Buy or Sell"
                                        ...
                                        Buy or Sell Your Products
                                    </label>
                                    <select
                                        required className="form-control"
                                        id="buysell1"
                                        onChange={InputEvent}>
                                        <option >Choose To Buy or Sell</option>
                                        <option name="buy" value={data.buy}>Buy</option>
                                        <option name="sell" value={data.sell}>Sell</option>
                                    </select>
                                </div>
